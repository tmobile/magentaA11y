...
<example>
  <form class="password-container js-password-group">
    ...
    <div class="password-toggle">
      <input type="checkbox" 
             id="show-password-1" 
             data-fn="togglePasswordVisibility"
             class="js-password-toggle">
      <label for="show-password-1">Show Password</label>
    </div>
    <input type="password"
          id="password-1"
          class="js-password-input"
          aria-describedby="password-toggle-1 password-hint-1"
          aria-required="true"
          required>
    <div id="password-hint-1" class="hint">
      Use any length of characters including emojis.
    </div>
  </form>
</example>
...
<form class="password-container button-variant" data-show-password="false" onsubmit="return false;">
    ...
    <div class="password-wrapper">
        <div id="password-toggle" class="password-toggle">
            <button class="Magentaa11y-button Magentaa11y-button--primary" type="button">
...
<example>
  <form class="password-container button-variant js-password-group" data-show-password="false" onsubmit="return false;">
    ...
    <div class="password-wrapper">
        <div class="password-toggle">
            <button class="button-tertiary js-password-toggle-btn" 
                    type="button" 
                    data-fn="togglePasswordButton"
