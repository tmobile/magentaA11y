...
<video controls>
  ...
  <track kind="captions" src="media/video/native/alert-dialog/alert-dialog_IosVoiceOver-en-US.vtt" srclang="en" label="English">
...
<video controls>
  ...
  <track kind="captions" src="media/video/native/alert-dialog/alert-dialog_AndroidTalkback-en-US.vtt" srclang="en" label="English">
  Your browser does not support the video tag.
</video>
