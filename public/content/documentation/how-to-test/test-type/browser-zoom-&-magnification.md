...
2. ## How to test
    ...
    - Browser zoom testing must be complemented with visual inspection of the content and manual checks of retained page
      functionality after zoom settings have been changed on the Web page.
...
<div class="how-to-test-checklist-item" node="[object Object]"><h3>✓ Ensure text content remains legible when scaled to 200 percent browser zoom</h3><table class="column-2"><thead><tr><th scope="col">Pass</th><th scope="col">Fail</th></tr></thead><tbody><tr><td><p>Content scales up and remains legible</p></td><td><p class="contrast-fail-1">Content is NOT legible</p></td></tr><tr><td><p class="contrast-fail-2">Screenshot placeholder</p></td><td><p class="contrast-fail-3">Screenshot placeholder</p></td></tr></tbody></table></div>

<div class="how-to-test-checklist-item" node="[object Object]"><h3>✓ Ensure Web page content and text in form controls is not partially cut off at 200 percent browser zoom (e.g., partially cutoff from complete access or view on either the left or right side of the page.)</h3><table class="column-2"><thead><tr><th scope="col">Pass</th><th scope="col">Fail</th></tr></thead><tbody><tr><td><p>Content scales up and is not cut off from view</p></td><td><p class="contrast-fail-1">Content or controls are partially cut off from view</p></td></tr><tr><td><p class="contrast-fail-2">Screenshot placeholder</p></td><td><p class="contrast-fail-3">Screenshot placeholder</p></td></tr></tbody></table></div>
	
<div class="how-to-test-checklist-item" node="[object Object]"><h3>✓ Ensure that text content does not truncate when scaled to 200 percent browser zoom</h3><table class="column-2"><thead><tr><th scope="col">Pass</th><th scope="col">Fail</th></tr></thead><tbody><tr><td><p>Content scales up and does not permanently trunctate </p></td><td><p class="contrast-fail-1">Content trunctates permanently preventing view</p></td></tr><tr><td><p class="contrast-fail-2">Screenshot placeholder</p></td><td><p class="contrast-fail-3">Screenshot placeholder</p></td></tr></tbody></table></div>
	
<div class="how-to-test-checklist-item" node="[object Object]"><h3>✓ Ensure Web page content and text in form controls is not partially cut off at 200 percent browser zoom (e.g., partially cutoff from complete access or view on either the left or right side of the page.)</h3><table class="column-2"><thead><tr><th scope="col">Pass</th><th scope="col">Fail</th></tr></thead><tbody><tr><td><p>Content scales up in form inputs and does not permanently trunctate </p></td><td><p class="contrast-fail-1">Content in form inputs trunctates permanently preventing view</p></td></tr><tr><td><p class="contrast-fail-2">Screenshot placeholder</p></td><td><p class="contrast-fail-3">Screenshot placeholder</p></td></tr></tbody></table></div>	

<div class="how-to-test-checklist-item" node="[object Object]"><h3>✓ Ensure that text content does not overlap when scaled to 200 percent browser zoom</h3><table class="column-2"><thead><tr><th scope="col">Pass</th><th scope="col">Fail</th></tr></thead><tbody><tr><td><p>Content scales up and does not overlap</p></td><td><p class="contrast-fail-1">Content overlaps</p></td></tr><tr><td><p class="contrast-fail-2">Screenshot placeholder</p></td><td><p class="contrast-fail-3">Screenshot placeholder</p></td></tr></tbody></table></div>

<div class="how-to-test-checklist-item" node="[object Object]"><h3>✓ Ensure that text content and form elements do not completely disappear when browser zoom is set to 200 percent.</h3><table class="column-2"><thead><tr><th scope="col">Pass</th><th scope="col">Fail</th></tr></thead><tbody><tr><td><p>Content scales up and does not disappear</p></td><td><p class="contrast-fail-1">Content completely disappears</p></td></tr><tr><td><p class="contrast-fail-2">Screenshot placeholder</p></td><td><p class="contrast-fail-3">Screenshot placeholder</p></td></tr></tbody></table></div>
	
<div class="how-to-test-checklist-item" node="[object Object]"><h3>✓ Ensure that text content does not truncate when scaled to 400 percent browser zoom</h3><table class="column-2"><thead><tr><th scope="col">Pass</th><th scope="col">Fail</th></tr></thead><tbody><tr><td><p>Content scales up and does not permanently trunctate</p></td><td><p class="contrast-fail-1">Content trunctates </p></td></tr><tr><td><p class="contrast-fail-2">Screenshot placeholder</p></td><td><p class="contrast-fail-3">Screenshot placeholder</p></td></tr></tbody></table></div>

<div class="how-to-test-checklist-item" node="[object Object]"><h3>✓ Ensure that text content does not overlap when scaled to 400 percent browser zoom</h3><table class="column-2"><thead><tr><th scope="col">Pass</th><th scope="col">Fail</th></tr></thead><tbody><tr><td><p>Content scales up and does not does not overlap</p></td><td><p class="contrast-fail-1">Content overlaps </p></td></tr><tr><td><p class="contrast-fail-2">Screenshot placeholder</p></td><td><p class="contrast-fail-3">Screenshot placeholder</p></td></tr></tbody></table></div>

<div class="how-to-test-checklist-item" node="[object Object]"><h3>✓ Ensure Web page content and form controls are not partially cut off at 400 percent browser zoom (e.g., partially cutoff from complete access or view on the left or right side of the page)</h3><table class="column-2"><thead><tr><th scope="col">Pass</th><th scope="col">Fail</th></tr></thead><tbody><tr><td><p>Content scales up and is not partially cutoff from access or view</p></td><td><p class="contrast-fail-1">Content is partially cutoff from access or view</p></td></tr><tr><td><p class="contrast-fail-2">Screenshot placeholder</p></td><td><p class="contrast-fail-3">Screenshot placeholder</p></td></tr></tbody></table></div>	

<div class="how-to-test-checklist-item" node="[object Object]"><h3>✓ Ensure Web page content and form controls reflow to remain available at 400 percent browser zoom</h3><p><strong>Note:</strong> Content and functionality are allowed to collapse behind menus or expand/collapse disclosure elements as long as the content or functionality is equivalent to what is offered at the default 100 percent browser zoom.</p><table class="column-2"><thead><tr><th scope="col">Pass</th><th scope="col">Fail</th></tr></thead><tbody><tr><td><p>Content and form controls reflow to remain available</p></td><td><p class="contrast-fail-1">Content or form controls are partially blocked from access or completely removed</p></td></tr><tr><td><p class="contrast-fail-2">Screenshot placeholder</p></td><td><p class="contrast-fail-3">Screenshot placeholder</p></td></tr></tbody></table></div>

<div class="how-to-test-checklist-item" node="[object Object]"><h3>✓ Ensure that no text content, form elements, or controls completely disappear when browser zoom is set to 400 percent (e.g., no loss of content)</h3><p><strong>Note:</strong> Content and functionality are allowed to collapse behind menus or expand/collapse disclosure elements as long as the content or functionality is equivalent to what is offered at the default 100 percent browser zoom.</p><table class="column-2"><thead><tr><th scope="col">Pass</th><th scope="col">Fail</th></tr></thead><tbody><tr><td><p>Content and form controls remain available</p></td><td><p class="contrast-fail-1">Content or form controls completely disappear</p></td></tr><tr><td><p class="contrast-fail-2">Screenshot placeholder</p></td><td><p class="contrast-fail-3">Screenshot placeholder</p></td></tr></tbody></table></div>

<div class="how-to-test-checklist-item" node="[object Object]"><h3>✓ Ensure horizontal scroll bar scrolling is not required to access essential content and functionality</h3><p><strong>Exceptions:</strong> Content in two-dimensional layouts such as maps, diagrams, video, games, persistent toolbars, presentations, and data tables.</p><table class="column-2"><thead><tr><th scope="col">Pass</th><th scope="col">Fail</th></tr></thead><tbody><tr><td><p>Content and form controls can be accessed without horizontal scroll bars</p></td><td><p class="contrast-fail-1">Content or form controls can only be viewed or accessed by scrolling into view with horizontal scroll bars</p></td></tr><tr><td><p class="contrast-fail-2">Screenshot placeholder</p></td><td><p class="contrast-fail-3">Screenshot placeholder</p></td></tr></tbody></table></div>
