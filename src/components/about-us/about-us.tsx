      ...
      <div className="MagentaA11y-about__info-section">
        <div className="MagentaA11y-about__info-container">
          ...
          <div className="MagentaA11y-about__info-item">
            ...
            <p>Today, MagentaA11y is being used by thousands of product teams around the world and embraced by
              non-profits and accessibility advocates as a powerful, practical resource for creating inclusive digital
              experiences from the start.
              Together, we are building a digitally accessible future for all.</p>
