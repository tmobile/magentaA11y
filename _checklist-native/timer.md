...
mobile gestures:
  swipe: |
    Focus moves to the interactive control, expresses its name, role, state (if applicable)
  doubletap: |
    Activates the control
    
screenreader: 
  name:  |
    Purpose is clear (ex: "Start/Pause")
  role:  |
    Identifies itself as a button 
  
group: |
    Group elements that help make the announcements logical
