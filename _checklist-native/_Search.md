...
- Ensure the placeholder does not take the place of the programmmatic name for the search field
- If auto results populate, add an optional announcement to the programmatic name so the user knows there are options to choose from
