...
<video controls>
  <source src="media/video/native/search/search_IosVoiceOver.webm" type="video/webm">
  <track kind="captions" src="media/video/native/search/search_IosVoiceOver-en-US.vtt" srclang="en" label="English">
...
<video controls>
  ...
  <track kind="captions" src="media/video/native/search/search_AndroidTalkback-en-US.vtt" srclang="en" label="English">
  Your browser does not support the video tag.
</video>
